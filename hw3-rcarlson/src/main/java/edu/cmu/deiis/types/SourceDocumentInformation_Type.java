...
/* First created by JCasGen Tue Oct 01 10:33:35 EDT 2013 */
 ...
 * Updated by JCasGen Wed Oct 02 22:22:50 EDT 2013
 * @generated */
public class SourceDocumentInformation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.SourceDocumentInformation");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "edu.cmu.deiis.types.SourceDocumentInformation");
  ...
  public int getOffsetInSource(int addr) {
      ...
      jcas.throwFeatMissing("offsetInSource", "edu.cmu.deiis.types.SourceDocumentInformation");
  ...
  public int getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "edu.cmu.deiis.types.SourceDocumentInformation");
  ...
  public boolean getLastSegment(int addr) {
      ...
      jcas.throwFeatMissing("lastSegment", "edu.cmu.deiis.types.SourceDocumentInformation");
